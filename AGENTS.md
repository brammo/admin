...
src/Controller/Component/    FilterComponent (index filters + sort/page session)
...
- **FilterComponent**: Opt-in list filters + sort/page session; see [docs/FILTER.md](docs/FILTER.md)
